export default async function putData(URL, data){
    // Our Try/Catch block is used to handle any errors that may occur during the fetch request.
try {
    ...
    const response = await fetch(URL, {
        // We first need to define the method of the request. In this case, we are sending a PUT request.
        method: 'PUT',
        ...
        // Most of the time I prefer to make the object prior to this step, so I can manipulate the data before sending it to the API.
